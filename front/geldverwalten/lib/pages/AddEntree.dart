  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          actions:  [Text(solde.toString(),style: const TextStyle(fontSize: 50),),],
        ),
              ...
              child: Stack(
                ...
                children: [
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                              ...
                              child: Container(
                                ...
                                width: MediaQuery.of(context).size.width/3.3,
                                child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [Text("raison"),Text("montant"),],)
                              )
                          );
                        }),*/
                  ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: solde<0?Colors.red:Colors.yellow,
